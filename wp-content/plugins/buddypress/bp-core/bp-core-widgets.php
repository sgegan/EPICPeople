...
class BP_Core_Login_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php else : ?>
			...
			<form name="bp-login-form" id="bp-login-widget-form" class="standard-form sg-login-styles" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
				<label for="bp-login-widget-user-login"><?php _e( '', 'buddypress' ); ?></label>
				<input type="text" name="log" id="bp-login-widget-user-login" class="input" value="" placeholder='USERNAME' />

				<label for="bp-login-widget-user-pass"><?php _e( '', 'buddypress' ); ?></label>
			...
			<!--	<div class="forgetmenot"><label><input name="rememberme" type="checkbox" id="bp-login-widget-rememberme" value="forever" /> <?php _e( 'Remember Me', 'buddypress' ); ?></label></div>
				-->
				<input type="submit" name="wp-submit" id="bp-login-widget-submit sg-login-link " value="<?php esc_attr_e( 'Log In', 'buddypress' ); ?>" />
